...
--
-- Host: 127.0.0.1    Database: tos-peak
-- ------------------------------------------------------
...
CREATE TABLE `brands` (
  ...
  `view_order` int(10) unsigned NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `brands_name_unique` (`name`),
  KEY `brands_view_order_index` (`view_order`)
...
CREATE TABLE `catalog_attributes` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `catalog_attributes_type_name_unique` (`type`,`name`),
  KEY `catalog_attributes_type_view_order_index` (`type`,`view_order`),
  KEY `catalog_attributes_category_id_foreign` (`category_id`),
  CONSTRAINT `catalog_attributes_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL
...
CREATE TABLE `payments` (
  ...
  `khqr_md5` varchar(255) DEFAULT NULL,
  ...
  KEY `payments_khqr_md5_index` (`khqr_md5`),
...
CREATE TABLE `products` (
  ...
  CONSTRAINT `products_color_id_foreign` FOREIGN KEY (`color_id`) REFERENCES `catalog_attributes` (`id`) ON DELETE SET NULL,
  CONSTRAINT `products_size_id_foreign` FOREIGN KEY (`size_id`) REFERENCES `catalog_attributes` (`id`) ON DELETE SET NULL,
  CONSTRAINT `products_sub_category_id_foreign` FOREIGN KEY (`sub_category_id`) REFERENCES `catalog_attributes` (`id`) ON DELETE SET NULL
...
CREATE TABLE `telegram_notification_logs` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `type` varchar(255) NOT NULL DEFAULT 'low_stock',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `telegram_notification_logs_product_id_foreign` (`product_id`),
  CONSTRAINT `telegram_notification_logs_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE SET NULL
...
-- Dump completed on 2026-07-13 14:25:26
