...
import { X, Loader2, Tag, Layers, Footprints, Plus, Settings, Send } from 'lucide-react';
            ...
            <div className="relative overflow-hidden rounded-2xl bg-[#F8F6F4] text-[#111111]">
                ...
                <div className="flex items-center justify-between border-b border-black/5 bg-white px-6 py-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-lg font-bold text-[#4B2E2B]">Inventory Stock Details</h3>
                    </div>
                    <button
                        type="button"
                        onClick={onClose}
                                                ...
                                                <div className="grid grid-cols-3 gap-2">
                                                    {details.sizes
                                                        ...
                                                        .map((v) => {
                                                            ...
                                                            // Ensure structure matches parent callbacks expects (like brand name, etc.)
                                                            const variantObj = {
                                                                id: v.id,
                                                            ...
                                                            return (
                                                                <div
                                                                    key={v.id}
                                                                    className={`flex flex-col items-center justify-between p-2.5 rounded-xl border transition space-y-2 ${
                                                                        isOutOfStock
                                                                            ? 'bg-red-50/20 border-red-100/50 text-red-700/60'
                                                                            : isLowStock
                                                                            ? 'bg-amber-50/40 border-amber-100 text-amber-850'
                                                                ...
                                                                >
                                                                    ...
                                                                    {/* Action Row */}
                                                                    <div className="border-t border-black/5 pt-1.5 flex items-center justify-center gap-1.5 w-full">
                                                                        <button
                                                                            type="button"
                                                                            onClick={() => onStockIn(variantObj)}
                                                                            className="h-6 w-6 flex items-center justify-center rounded bg-gray-150 hover:bg-gray-250 text-gray-700 transition"
