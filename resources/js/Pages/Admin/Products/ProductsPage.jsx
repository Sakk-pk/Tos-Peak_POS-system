...
export default function ProductsPage({
    ...
    }, [category, subCategory, products, searchTerm]);
    ...
    return (
        <AdminLayout navbarTitle="Products" contentClassName="px-8 py-6 space-y-6">
            ...
            <Card padding="p-4" className="space-y-4">
                ...
                <div className="border-t border-black/[0.06] pt-3.5 flex items-center gap-2 overflow-x-auto pb-1.5 scrollbar-thin">
                    <span className="text-[9px] font-black font-display text-gray-400 uppercase tracking-widest flex items-center gap-1.5 mr-2 shrink-0">
