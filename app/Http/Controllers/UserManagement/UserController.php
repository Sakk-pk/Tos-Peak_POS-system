...
class UserController extends Controller
{
    ...
    /**
     * Directly create a new team member with an assigned role.
     * Authorized by the team-members module permission (check:team-members middleware).
     */
    public function store(Request $request)
    {
        ...
        Log::info("New staff member {$user->email} created with role {$validated['role']} by admin ID " . Auth::id());

        return to_route('users.index')->with('success', 'Team member added successfully.');
    }

    /**
     * Update a staff member's role only.
     * Administrators may not change passwords or personal details from this panel;
     * staff manage their own credentials via their profile.
     */
