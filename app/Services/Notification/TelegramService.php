...
class TelegramService
{
     ...
     */
    public function sendLowStockAlert(\App\Models\Product\Product $product): void
    {
     ...
     */
    public function sendOutOfStockAlert(\App\Models\Product\Product $product): void
    {
        $token = $this->lowStockBotToken;
        if (!$this->isConfigured($token)) {
     ...
     */
    public function sendPaymentStatusAlert(\App\Models\Payment\Payment $payment): void
    {
        $token = $this->paymentBotToken;
        if (!$this->isConfigured($token)) {
